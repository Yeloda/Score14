...
const Top14CalendarScreen = ({navigation, route}) => {
    ...
    useEffect(() => {
        ...
        async function getMatches(){
            ...
            fetch("https://v1.rugby.api-sports.io/games?season=2024&league=16&date="+today, {
                "method": "GET",
                "headers": {
    ...
    const fetchDateMatches = async (date) => {
        ...
        fetch("https://v1.rugby.api-sports.io/games?season=2024&league=16&date="+searchDate, {
            "method": "GET",
            "headers": {
                "x-rapidapi-host": "v1.rugby.api-sports.io",
                "x-rapidapi-key": process.env.API_KEY
