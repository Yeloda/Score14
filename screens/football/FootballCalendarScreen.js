...
const FootballCalendarScreen = ({navigation, route}) => {
    ...
    async function getMatches(){
        ...
        fetch("https://v3.football.api-sports.io/fixtures?season=2024&league=61&date="+today, {
            "method": "GET",
            "headers": {
    ...
    const fetchDateMatches = async (date) => {
        ...
        fetch("https://v3.football.api-sports.io/fixtures?season=2024&league=61&date="+searchDate, {
            "method": "GET",
            "headers": {
                "x-rapidapi-host": "v3.football.api-sports.io",
                "x-rapidapi-key": process.env.API_KEY
